...
class INFOGAN:
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        X_train = np.load('../datasets/swedish_leaf32x32pix_images.npy')
        y_train = np.load('../datasets/swedish_leaf32x32pix_labels.npy')

        # Configure inputs
        X_train = (X_train.astype(np.float32) - 127.5) / 127.5
        # y_train ranges from 1-15 should 0-14
        # For some reason y_train is not used here
        # y_train -= 1
