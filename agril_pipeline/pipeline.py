...
def split_data(split=.8):
    images = np.load('data/agrilplant64x64pix_all_images.npy')
    labels = np.load('data/agrilplant64x64pix_all_labels.npy')
    x_train = []
    y_train = []
    x_test = []
    y_test = []
...
if __name__ == '__main__':
    ...
    pipe.n_runs(n=6, split=split, gan_epochs=100000, alexnet_epochs=600,  alexnet_lr=0.00001)
